...
public:
	...
	*/
	...
	double FREQ_STEP = 0.95367431640625; // ( ( double )( XTAL_FREQ / ( double )FREQ_DIV ) )
	double FREQ_ERR  = 0.47683715820312;
	...
	enum {
		 ...
		 */
		REG_FREQUENCY_ERRORBASEADDR = 0x076B,
...
public:
	...
	struct {
		...
		*/
		...
		//
		std::function<void()> rxPreambleDone;
...
public:
	/*!
	 * \brief Instantiates a SX126x object
	 */
	SX126x() = default;
...
private:
	 ...
	 */
	RadioOperatingModes_t OperatingMode = MODE_SLEEP;
...
public:
	...
	void SetNetworkType(NetworkType_t nt);
	 ...
	 *
	 */
	virtual void SetDeviceType(DeviceType_t devtype);
